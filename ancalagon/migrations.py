...
DIRECTORY = pathlib.PurePath(__file__).parent / "migrations"
...
def _script(version: int, direction: str, fs: FileSystem) -> pathlib.PurePath:
...
def migrate_file(path: pathlib.PurePath, target: int, fs: FileSystem) -> tuple[int, int]:
