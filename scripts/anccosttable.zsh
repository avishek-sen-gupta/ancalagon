...
# Usage: anccost <config.toml | dir> | anccosttable [--by-agent]
#        anccosttable --input report.json [--output table.txt] [--by-agent]
...
parser = argparse.ArgumentParser(prog="anccosttable")
