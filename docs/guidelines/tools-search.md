...
Use ast-grep for structural code searches instead of regex grep. It matches AST patterns and handles multi-line constructs, indentation variations, and nested expressions that regex misses.

**When to use ast-grep:**
- Searching for constructor/function call patterns (e.g. `AgentSpec(task_id=$X)`)
...
- Simple keyword/string searches
- Import statements
